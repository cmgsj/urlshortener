...
type UserServiceClient interface {
	...
	CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*NoContent, error)
}
...
func (c *userServiceClient) GetUserByEmail(ctx context.Context, in *GetUserByEmailRequest, opts ...grpc.CallOption) (*GetUserResponse, error) {
	out := new(GetUserResponse)
	err := c.cc.Invoke(ctx, "/userpb.UserService/GetUserByEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userServiceClient) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...grpc.CallOption) (*NoContent, error) {
	out := new(NoContent)
...
type UserServiceServer interface {
	...
	CreateUser(context.Context, *CreateUserRequest) (*NoContent, error)
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *CreateUserRequest) (*NoContent, error) {
...
func _UserService_GetUserByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/userpb.UserService/GetUserByEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/proto/userpb/userpb.proto",
}
